...
/**
 * This is the item provider adapter for a {@link sql.Annotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Annotation_args_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Annotation_args_feature", "_UI_Annotation_type"),
				 SqlPackage.Literals.ANNOTATION__ARGS,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SqlPackage.Literals.ANNOTATION__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Annotation.class)) {
			case SqlPackage.ANNOTATION__ARGS:
			case SqlPackage.ANNOTATION__NAME:
