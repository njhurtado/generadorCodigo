 ...
 * <p>Descripcion: Comando de ServicioNegocio utilizado para consultar un objeto ProcesoDocumentos.</p>
 ...
 * </pre>
 */
public class DCmdSrvConsProcesoDocumentos extends  DComandoServicioNegocio {
	...
	public Object clonar() {
		return new DCmdSrvConsProcesoDocumentos();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdSrvConsProcesoDocumentos) {
			DCmdSrvConsProcesoDocumentos copia = (DCmdSrvConsProcesoDocumentos) comando;
