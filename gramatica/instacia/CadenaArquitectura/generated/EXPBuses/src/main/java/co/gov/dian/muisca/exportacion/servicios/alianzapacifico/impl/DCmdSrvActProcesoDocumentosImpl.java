 ...
 * <p>Descripcion: Comando de servicio utilizado para Actualizar un objeto ProcesoDocumentos.</p>
 ...
 * </pre>
 */
public class DCmdSrvActProcesoDocumentosImpl extends DCmdSrvActProcesoDocumentos {
  ...
  protected void ejecutarComando() throws DExcepcion {
    ...
    try {
      ...
      // Actualizar
      dao.inicializarActualizar(toProcesoDocumentos);
      admin.guardar(dao);
    }
    finally {
      admin.cerrarSesion();
