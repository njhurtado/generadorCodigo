package co.gov.dian.muisca.exportacion.web.general.to.generico;
...
public class DExportacionWebDTO extends DGenericoWebDTO {

    private static final long serialVersionUID = -3920224824520595894L;
    private static Logger logger = Logger.getLogger(  DExportacionWebDTO.class );
    
    
    public DExportacionWebDTO( String name ) {
        super( name );
    }

    public DExportacionWebDTO( DGenericoDTO genericoDTO ) {
        super( genericoDTO );
