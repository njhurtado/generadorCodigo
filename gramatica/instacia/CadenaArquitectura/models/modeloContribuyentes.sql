...
Aplication Automatizacion 

package "co.gov.dian.muisca.automatizacion"

sufijoPkg "contribuyentes"
...
CREATE TABLE  CONTRIBUYENTE @TableDetail(tableRelation "CONTRIBUYENTE_DIRECCION")
(
	...
	IDE_TIPO_DOCUMENTO NUMBER(8) NOT NULL @Filtro, @ReferenceMode(refs "DOMINIO=123"),
	NUM_IDENTIDAD VARCHAR2(50) @Filtro,
	NUM_NIT NUMBER(14),
	IDE_USUARIO_CAMBIO NUMBER(14) NOT NULL,
	FEC_CAMBIO TIMESTAMP(1) NOT NULL,
...
(
	...
	IDE_DEPARTAMENTO NUMBER(8) NOT NULL @ComboMode,@ReferenceMode(refs "LUGAR=108"),
	IDE_MUNICIPIO NUMBER(8) NOT NULL @ComboMode,@ReferenceMode(refs "LUGAR=109"),
