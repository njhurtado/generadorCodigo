 ...
 * </p>
 * <ul>
 *   <li>{@link sql.impl.AnnotationImpl#getArgs <em>Args</em>}</li>
 *   <li>{@link sql.impl.AnnotationImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AnnotationImpl extends MinimalEObjectImpl.Container implements Annotation {
	...
	public void setArgs(String newArgs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SqlPackage.ANNOTATION__ARGS, oldArgs, args));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SqlPackage.ANNOTATION__NAME, oldName, name));
	}
